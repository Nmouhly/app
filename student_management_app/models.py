...
class CustomUser(AbstractUser):
    user_type_data=((1,"HOD"),(2,"Staff"),(3,"Etudiant"))
...
class Etudiant(models.Model):
    ...
    admin = models.OneToOneField(
        'CustomUser', on_delete=models.CASCADE, related_name='etudiant'
    ) 
    ...
    classe = models.ForeignKey(
        Classe, on_delete=models.CASCADE, related_name='etudiants',
    )  
    objects=models.Manager()
    @property
    def classe_nom(self):
